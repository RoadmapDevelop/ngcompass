...
import { normalizePattern, expandPatterns, isValidPattern, validatePatterns } from '../src/patterns.js';
...
describe('validatePatterns', () => {
    it('separates valid patterns and generates error messages for invalid ones', () => {
        ...
        expect(errors).toEqual(['Invalid pattern: "   "', 'Invalid pattern: "src/***/bad.ts"']);
    });
