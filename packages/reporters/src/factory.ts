...
export function getReporter(
  ...
  switch (format) {
    ...
    case 'html':
    case 'ui':
      return new CompoundReporter(
        new HtmlReporter(options?.outputPath, undefined, true),
        options
      );
    default: {
