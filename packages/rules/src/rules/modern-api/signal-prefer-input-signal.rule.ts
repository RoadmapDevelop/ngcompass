...
import { AstNode, getClassBody, getNodeStart, unwrapNode } from '../../rule-utils';
...
export const signalPreferInputSignalRule = createAnyAngularClassRule(
    ...
    (classNodeWrapper: AnyAngularClassNode, context: RuleContext): RuleFailure[] | null => {
        ...
        for (const member of classBody) {
            ...
            if (!m || (m.type !== 'PropertyDefinition' && m.type !== 'AccessorProperty') || !Array.isArray(m.decorators)) continue;
