...
import { CallExpression, ClassDeclaration, ComponentMetadata, Decorator, Expression, NewExpression, PropertyDefinition, analyzeComponent, getDecoratorNameUnsafe } from '@ngcompass/ast';
