...
import {
  buildVisitorMap,
  STREAM_TO_NODE_TYPE,
} from '../../src/execution/visitor-registry.js';
import type { StreamType } from '../../src/execution/rule-handler.js';
import type { RuleHandler } from '../../src/execution/rule-handler.js';
